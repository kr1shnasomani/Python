...
> **Note:**
> `a` and `b` may contain duplicate elements, but the union array must contain unique elements.

## Example

**Input:** `n = 5`, `m = 3`, `a = [1, 2, 3, 4, 6]`, `b = [2, 3, 5]`
...
Common elements in `a` and `b` are: `[2]`
